...
/* PGA API's */
/**
 * \brief ADC0 PGA Enable 
 * Enables the PGA functionality by setting the enable-bit in the PGA control register
 *
 * \return Nothing
 */
...
/**
 * \brief ADC0 PGA Disable
 * Disables the PGA functionality by disabling the enable-bit in the PGA control register
 *
 * \return Nothing
 */
...
/**
 * \brief ADC0 PGA Gain Setting
 * Controls the gain setting for the PGA.
 *
 * \return Nothing
 */
...
/**
 * \brief ADC0 PGA Bias Select
 * Controls the bias current supplied to the PGA
 *
 * \return Nothing
 */
...
/**
 * \brief ADC0 PGA Sample Duration
 * Controls the sampling duration for the ADC to sample the PGA output.
 *
 * \return Nothing
 */
